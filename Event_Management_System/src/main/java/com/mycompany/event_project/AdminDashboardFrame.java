...
public class AdminDashboardFrame extends JFrame {
    ...
    private JButton createMainActionButton(String text) {
        ...
        // No custom colors: use default Look & Feel colors

        // Unified size for all buttons
    ...
    // Create a new event by collecting data via dialogs and inserting into DBConnection
