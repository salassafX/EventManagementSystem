...
public class OrganizerDashboardFrame extends JFrame {
    ...
    setTitle("Organizer");
    setSize(1000, 650); // زيادة العرض قليلاً
    setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    // استخدم BorderLayout للنافذة الرئيسية
    ...
    tabs.setTabPlacement(JTabbedPane.LEFT); // التبويبات على اليسار
    
    // تغيير حجم الخط في التبويبات
    ...
    // الأزرار على اليمين بدلاً من الأسفل
    ...
    // لوحة تحتوي على الجدول والأزرار
    ...
    private void loadEvents() {
        DefaultTableModel model = new DefaultTableModel(
                new String[]{"ID", "Title", "type", "Location", "Date", "Capacity"}, 0
        );
